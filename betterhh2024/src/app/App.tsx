...
function App() {
  return (
    <div className="flex flex-col overflow-hidden bg-[#141416] relative pb-32">
      ...
      <div className="flex w-full flex-1 m-5 mb-28">
        ...
        <img className="absolute z-10 top-28 right-0 left-[-25%] w-[125%] max-w-[758px] max-h-[758px] object-cover" src='/8513384.png' alt='Joseph'></img>
